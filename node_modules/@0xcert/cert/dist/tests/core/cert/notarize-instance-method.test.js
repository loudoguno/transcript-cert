...
spec.test('returns proofs for a complete a complete schema', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const cert = new cert_1.Cert({
        schema: schema_1.exampleSchema,
    });
    const proofs = yield cert.notarize(schema_1.exampleData);
